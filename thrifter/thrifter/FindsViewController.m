...
- (IBAction)done:(UIStoryboardSegue *)segue
{
    if ([[segue identifier] isEqualToString:@"UnwindAddFind"]) {
        ...
        Find *findToAdd = [[Find alloc] initWithDataAndKey:[[addController TextFieldName] text] cost:cost date:[NSDate date] store:[addController storeKey] description:[[addController TextFieldDescription] text] picture:[addController imageData] key:[[self dataController] FindKey] categoryKeys:[addController categoryKeys]];
